...
<div class="flex items-center justify-center min-h-screen bg-rose-50">
	<div class="relative flex flex-col m-6 space-y-10 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0 md:m-0">
		<div class="p-6 md:p-20">
			<h2 class="font-mono mb-6 text-4xl font-bold">Log In</h2>
			...
			<input
				type="text"
				class="w-full p-6 border border-gray-300 rounded-md placeholder:font-size placeholder:font-light"
			...
			<div class="flex flex-col space-x-0 space-y-6 md:flex-row md:space-x-4 md:space-y-0 md:-mx-1">
				...
				>
					<img src="login-modal/facebook.png" alt="" class="w-9" />
					<span class="font-thin">Facebook</span>
				</button>
				<button
					class="flex items-center justify-center py-2 space-x-3 border border-gray-300 rounded shadow-sm hover:bg-opacity-30 hover:shadowl-lg hover:translate-y-0.5 transition duration-150 md:w-1/2"
				>
					<img src="login-modal/google.png" alt="" class="w-9" />
